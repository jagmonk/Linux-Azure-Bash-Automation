# Azure Linux Cost and Tag Audit

## Purpose

Use Azure Resource Graph to report Linux VM ownership tags and cost governance gaps.
...
```bash
chmod +x scripts/azure-linux-cost-tag-audit.sh
./scripts/azure-linux-cost-tag-audit.sh
```
...
Built a Bash-based azure linux cost and tag audit automation project using Azure CLI, jq, structured reporting, polished headers, and operational documentation for hybrid cloud Systems Administration.
